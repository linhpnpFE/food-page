$(function () {
  ...
  var swiper = new Swiper(".swiper-1-2-4 .mySwiper", {
    slidesPerView: 1,
    spaceBetween: 10,
    navigation: {
  ...
  $('.top-product i').on('click', function () {
...
$(window).scroll(function () {
  ...
  if (scroll >= 10) {
    $(".header-page").addClass("box-shadow");
  } else {
    $(".header-page").removeClass("box-shadow");
  }
});
...
$(function($) {
  ...
  $(".count-number .time").data("countToOptions", {
